...
function draw() {
  // AUDIO // Get the overall volume (between 0 and 1.0)
  var volume = input.getLevel();
  //var volume = map(mouseX, 0, width, 0, 1.0);
  console.log(volume)
  // AUDIO //


  // draw the current character in the string:
  drawIt(thestring[whereinstring], volume); 
...
function drawIt(k, volume) {
  ...
  // AUDIO //
  var radius = map(volume, 0, 1, 30, step*5);
  // AUDIO //
